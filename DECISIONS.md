...
**Status:** in progress — **P1 shipped** (`89f7015`, live game states + ticker parity), **P2 shipped** (`ef59029`, Data-Story hero), **P3 shipped** (`398f886`, Headlines + Insights rail), **P4 partial** (Pennant-Races viz + freshness timestamps shipped; visual-weight tiers, sport-status→pills, two-column rail pending a live screenshot review); P5–P6 pending. Owner ratified direction (ad-free; P1–6 scope).
