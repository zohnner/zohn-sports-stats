...
**Status:** diagnosed and documented; no code changed yet — awaiting owner direction on scope of the fix
**Contributors:** Axiom (investigation)
**Date opened:** 2026-08-22 | **Date resolved:** open (diagnosis only)
...
**Escalation:** none — this is a diagnosis, not a defect requiring urgent action. The internal-linking fix is a real, scoped follow-up project; flagging here rather than starting it unprompted given its size.
