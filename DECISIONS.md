...
**Next:** M1 proof (title-card + adp-delta + outro, cue-sheet timing, one real rendered clip) — in progress this session. M2 (P1 templates, full episode, shorts derivation) and M3 (forced alignment, live data pull) are not started.
