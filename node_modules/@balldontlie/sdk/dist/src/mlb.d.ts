...
import type { ApiResponse, MLBTeam, MLBPlayer, MLBGame, MLBStats, MLBStandings, MLBSeasonStats, MLBTeamSeasonStats, MLBPlayerInjury } from "./types";
export declare class MLBClient extends BaseClient {
    ...
    getPlayer(id: number): Promise<ApiResponse<MLBPlayer>>;
