...
import type { ApiResponse, NFLTeam, NFLPlayer, NFLGame, NFLStats, NFLStandings, NFLAdvancedPassingStats, NFLAdvancedReceivingStats, NFLAdvancedRushingStats, NFLPlayerInjury, NFLSeasonStats } from "./types";
export declare class NFLClient extends BaseClient {
    ...
    getPlayer(id: number): Promise<ApiResponse<NFLPlayer>>;
    getPlayers(params?: {
        cursor?: number;
        per_page?: number;
        team_ids?: number[];
