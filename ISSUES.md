...
- **Interactive drive-history field mode, per-event-type push notifications, cross-sport engine abstraction** — all named, none started. Not forgotten, just not this round.
