...
function _seedSportTicker(sport) {
    if (sport === 'mlb') {
        ...
        if (typeof fetchNCAABScoreboard === 'function') {
            fetchNCAABScoreboard().then(games => {
...
function _renderNFLView(view) {
    ...
    switch (view) {
        case 'nfl-mock':
            ...
            break;
        case 'nfl-mydrafts':
            if (viewCount) viewCount.textContent = 'Draft HQ · My Drafts';
            if (typeof loadNFLMyDrafts === 'function') loadNFLMyDrafts();
            break;
        case 'nfl-myleague':
            if (viewCount) viewCount.textContent = 'Draft HQ · My League';
            if (typeof loadNFLMyLeague === 'function') loadNFLMyLeague();
            break;
        case 'nfl-draftkit':
