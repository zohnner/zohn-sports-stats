...
const ACHIEVEMENT_TAXONOMY = {
    ...
    mlb: {
        ...
        rookie_of_year:      { label: 'Rookie of the Year',              short: 'ROY',             group: 3 },
        gold_glove:          { label: 'Gold Glove Award',                short: 'Gold Glove',      group: 3 },
        silver_slugger:      { label: 'Silver Slugger Award',            short: 'Silver Slugger',  group: 3 },
        comeback_poy:        { label: 'Comeback Player of the Year',     short: 'Comeback POY',    group: 3 },
        roberto_clemente:    { label: 'Roberto Clemente Award',          short: 'Clemente Award',  group: 3 },
        all_star:            { label: 'All-Star Selection',              short: 'All-Star',        group: 4 },
    },
    ncaaf: {
